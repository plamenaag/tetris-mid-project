...
public class StickShape extends Shape {
    ...
    public StickShape(int centerX, int centerY, List<Block> blocks) {
    ...
    public void rotateH() {
        ...
        this.getBlocks().get(3).setXCoordinate(getCenterBlockX() + 2);
    ...
    public void rotateV() {
        ...
        this.getBlocks().get(3).setYCoordinate(getCenterBlockY() - 2);
    }
}
